...
Movie.delete_all
Movie.create(:omdb_key => 'tt0112384', :title => "Apollo 13", :year => 1995)
Movie.create(:omdb_key => 'tt0076759', :title => "Star Wars", :year => 1977)
Movie.create(:omdb_key => 'tt0162222', :title => "Cast Away", :year => 2000)
Movie.create(:omdb_key => 'tt0082971', :title => "Raiders of the Lost Ark", :year => 1981)
Movie.create(:omdb_key => 'tt0107290', :title => "Jurassic Park", :year => 1993)
Movie.create(:omdb_key => 'tt0362227', :title => "The Terminal", :year => 2004)
